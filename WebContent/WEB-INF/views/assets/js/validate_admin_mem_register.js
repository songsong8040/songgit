$(function() {
	...
	$("#mem_register_form").validate({
		...
		messages : {
			...
			mem_agree1 : { required: "이용 약관을 선택해 주세요." },
			
			mem_agree2 : { required: "개인정보 수집에 동의하여 주세요."},
			...
			sample6_postcode : {
				...
				number : "우편번호는 숫자만 입력 가능합니다."
			},
			// [주소] 필수
			sample6_address : {
				required : "주소를 입력하세요",
				kor : "주소는 한글만 입력 가능합니다."
			},
