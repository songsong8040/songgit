...
<div id="header" class="show clearfix">
    ...
    <a href="${pageContext.request.contextPath}/cart" class="cart_button">카트</a>
    ...
    <div class="overlay">
        ...
        <nav class="menu">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/product?cateno=4&subcateno=41">향수</a></li>
                <li><a href="#">홈</a></li>
                <li><a href="#">읽기</a></li>
                <li><a href="${pageContext.request.contextPath}/search/store_search">스토어</a></li>
            </ul>
        </nav>
        <div class="log_sear">
            <c:choose>
    ...
    <div class="overlay1">
        ...
        <nav class="menu1">
            <ul>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1">모두 보기</a></li>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1&subcateno=11">클렌저</a></li>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1&subcateno=12">트리트먼트 & 마스크</a></li>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1&subcateno=13">토너</a></li>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1&subcateno=14">립 & 아이</a></li>
                <li><a href="${pageContext.request.contextPath}/product?cateno=1&subcateno=15">선 케어 / SPF</a></li>
            </ul>
        </nav>
    </div>
    <div class="overlay2">
    	...
    	<nav class="menu2">
    		<ul>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=2">모두 보기</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=2&subcateno=21">샴푸</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=2&subcateno=22">컨디셔너</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=2&subcateno=23">트리트먼트</a></li>
    		</ul>
    	</nav>
    </div>
    <div class="overlay3">
    	...
    	<nav class="menu3">
    		<ul>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=3">모두 보기</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=3&subcateno=31">핸드</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=3&subcateno=32">바디</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=3&subcateno=33">퍼스널 케어</a></li>
    		</ul>
    	</nav>
    </div>
    <div class="overlay5">
    	...
    	<nav class="menu5">
    		<ul>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=5"">모두 보기</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=5&subcateno=52">홈</a></li>
    			<li><a href="${pageContext.request.contextPath}/product?cateno=5&subcateno=52">문학</a></li>
    		</ul>
    	</nav>
    </div>
    <div class="overlay6">
		...
		<nav class="menu_prod_search">
			<ul>
				<li>
					...
					<form method="post" action="${pageContext.request.contextPath}/product/product_list">
