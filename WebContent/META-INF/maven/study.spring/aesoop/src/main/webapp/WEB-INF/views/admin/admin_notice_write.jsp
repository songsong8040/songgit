...
<!-- 개별 style -->
<link rel="stylesheet" type="text/css" href="../assets/css/admin_notice_write.css" />
...
<body>
	...
	<div id="content" class="pull-left">
		<div id="content_pd">
			...
			<div class="write_box">
				<!-- [공통] (admin_common.css) -->
				<form id="addForm" method="post" action="${pageContext.request.contextPath}/admin/admin_notice_write_ok.do" enctype="multipart/form-data">
					...
					<div class="clearfix form-group">
						...
						<div class="col-md-11">
							<textarea name="content" id="text_form2" style="resize:none;"></textarea>
						</div>
					</div>
					<!-- 본문작성 끝 ----------------------------------------------------------------->
					<div class="h10">
					...
					<!-- 파일첨부 시작 ------------------------------------------------------------------->
					<div class="clearfix form-group">
						<label for='notice_img' class="col-md-1 form_title ">이미지 <span class='identify'>*</span></label>
						<div class="col-md-11">
					...
					<div class="form-group">
						<div class="btn_right">
							...
							&nbsp;&nbsp;
							 <a href="${pageContext.request.contextPath}" class="btn btn-warning">취소</a>
						</div>
					</div>
					<!-- 버튼 끝 ------------------------------------------------------------------->
				</form>
