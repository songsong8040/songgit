...
(function (factory) {
  ...
  function Slider2(element, options) {
    ...
    self.options = $.extend({}, Slider2.DEFAULTS, $.isPlainObject(options) ? options : {});
    self.init();
  }
  ...
  // Default settings
  Slider2.DEFAULTS = {
    activeClass: 'slider2-active', // for slide nav
    autoPlay: true,
    contentClass: 'slider2-content',
    disableClass: 'slider2-disabled', // for slide 'prev btn' and 'next btn'
    duration: 5000,
    effect: 'fade',
    easing: 'swing', // support 'swing' and 'linear', powered by jquery
    navClass: 'slider2-nav',
    nextClass: 'slider2-next',
    prevClass: 'slider2-prev',
    speed: 1000,
    trigger: 'click' // for slide nav
  };

  // Set default settings
  Slider2.setDefaults = function (options) {
    $.extend(Slider2.DEFAULTS, options);
  };

  // Save the other slider2
  Slider2.other = $.fn.slider2;
  ...
  $.fn.slider2 = function (options) {
    ...
    this.each(function () {
      ...
      if (!data) {
        ...
        $this.data(NAMESPACE, (data = new Slider2(this, options)));
      }
  ...
  $.fn.slider2.setDefaults = Slider2.setDefaults;

  // No conflict
  $.fn.slider2.noConflict = function () {
    $.fn.slider2 = Slider2.other;
    return this;
  };

  $(function () {
    $('[data-toggle="slider2"]').slider2();
  });
});
