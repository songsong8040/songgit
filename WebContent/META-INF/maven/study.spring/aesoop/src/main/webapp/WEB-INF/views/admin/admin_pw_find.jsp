...
<body>
	<header></header>
    <div id="container">
    <div id="form-horizontal_hd">비밀번호를 잊으셨습니까?</div>
        <form method="post" class="form-horizontal" name="join_form" id="join_form" action="${pageContext.request.contextPath}/pw_find_ok">
            ...
            <div class="form-group">
                <div class="text-center">
                    <button type="submit" class="btn btn-success" id="button">임시 비밀번호 받기</button>
