package study.spring.aesoop.interceptor;
...
public class AppInterceptor implements HandlerInterceptor {
	 ...
	 * return 값으로 boolean 값을 전달하는데 false 인 경우 controller를 실행시키지 않고 요청을 종료한다.
	 * 보통 이 곳에서 각종 체크작업과 로그를 기록하는 작업을 진행한다.
	 */
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		//log.debug("AppInterceptor.postHeldle 실행됨");
		// 컨트롤러 종료시의 시각을 가져온다.
